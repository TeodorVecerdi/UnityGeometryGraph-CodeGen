...
// ------------------------------------------------------------------------------";
        ...
        // 7: update from editor node methods, 8: GetValueForPort ifs, 9: OnPortValueChanged code, 10: OnAfterDeserialize
...
{9}
        ...
        // 0: using, 1: class name, 2: port fields, 3: port initializers, 4: serialization, 5: deserialization,
        // 6: update from editor node methods, 7: GetValueForPort ifs, 8: OnPortValueChanged code, 9: OnAfterDeserialize
...
{8}
        ...
        public static string SerializationTemplate = @"{0}public override string Serialize() {{
{0}    return new JArray {{
{1}
...
{0}}}";
        ...
        public static string DeserializationTemplate = @"{0}public override void Deserialize(string data) {{{1}
{0}}}";
        
        // 0: indent, 1: update/notify
        public static string OnAfterDeserializeTemplate = @"{0}public override void OnAfterDeserialize() {{{1}
{0}}}";
